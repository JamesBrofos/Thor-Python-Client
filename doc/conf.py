...
htmlhelp_basename = 'ThorPythonClientdoc'
...
man_pages = [
    (master_doc, 'thorpythonclient', 'Thor Python Client Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ThorPythonClient', 'Thor Python Client Documentation',
     author, 'ThorPythonClient', 'One line description of project.',
     'Miscellaneous'),
]
